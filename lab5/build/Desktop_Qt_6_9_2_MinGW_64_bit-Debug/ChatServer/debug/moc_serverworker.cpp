...
void serverWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->receiveJson(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (serverWorker::*)(const QJsonObject & )>(_a, &serverWorker::jsonReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (serverWorker::*)()>(_a, &serverWorker::disconnectedFromClient, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (serverWorker::*)(const QString & )>(_a, &serverWorker::logMessage, 2))
            return;
    }
}
