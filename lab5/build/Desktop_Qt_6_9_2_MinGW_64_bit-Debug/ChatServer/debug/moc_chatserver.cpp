...
template <> constexpr inline auto chatServer::qt_create_metaobjectdata<qt_meta_tag_ZN10chatServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'broadcast'
        QtMocHelpers::SlotData<void(const QJsonObject &, serverWorker *)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QJsonObject, 6 }, { 0x80000000 | 7, 8 },
        }}),
        // Slot 'jsonReceived'
        QtMocHelpers::SlotData<void(serverWorker *, const QJsonObject &)>(9, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 7, 10 }, { QMetaType::QJsonObject, 11 },
        }}),
        // Slot 'userDisconnected'
        QtMocHelpers::SlotData<void(serverWorker *)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 7, 10 },
        }}),
    };
