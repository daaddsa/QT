...
template <> constexpr inline auto ChatServer::qt_create_metaobjectdata<qt_meta_tag_ZN10ChatServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'jsonReceived'
        QtMocHelpers::SlotData<void(const QJsonObject &, ServerWorker *)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QJsonObject, 5 }, { 0x80000000 | 6, 7 },
        }}),
        // Slot 'userDisconnected'
        QtMocHelpers::SlotData<void(ServerWorker *)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
    };
...
void ChatServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->jsonReceived((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<ServerWorker*>>(_a[2]))); break;
